...
#'
#' Bind rows of both data and metadata of all [behavr] tables in a list.
#' It checks keys, number and names of columns are the same across all data.
#' In addition, it forbigs to bind metadata if it generates duplicates (same id in two different metadata)
#'
